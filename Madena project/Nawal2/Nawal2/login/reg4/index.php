...
if(isset($_POST['send']) && $_POST['send']){
    ...
    $transp = $_POST['transp'];
    $Notes = $_POST['Notes'];
    $query = "INSERT INTO regdata4(Name,Age,Country,Phone,Address,QuranKnow,Level,transp,Notes) VALUE('$Name','$Age','$Country','$Phone','$Address','$QuranKnow','$Level','$transp','$Notes')";
