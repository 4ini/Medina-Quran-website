...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE regdata3 set id='" . $_POST['id'] . "', Name='" . $_POST['Name'] . "', Age='" . $_POST['Age'] . "', Country='" . $_POST['Country'] . "', Phone='" . $_POST['Phone'] . "' , Address='" . $_POST['Address'] . "' , QuranKnow='" . $_POST['QuranKnow'] . "' , Level='" . $_POST['Level'] . "'  , Drash='" . $_POST['Drash'] . "' , transp='" . $_POST['transp'] . "' , Notes='" . $_POST['Notes'] . "' WHERE id='" . $_POST['id'] . "'");
$message = "<div class='alert alert-success'>
تم التعديل بنجاح
</div>";
}
$result = mysqli_query($conn,"SELECT * FROM regdata3 WHERE id='" . $_GET['id'] . "'");
...
<!--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
        <h3><label >مستوى التعليم :</label></h3>
        <select name="Drash" class="form-control input-lg" >
                <option   value="مستوى التعليم">مستوى التعليم</option>
				<option value="متعلمة"
        <?php if($row["Drash"]=='متعلمة') {
          echo "selected";
        } ?>    >متعلمة</option>
				
        <option value="غير متعلمة"
        <?php if($row["Drash"]=='غير متعلمة') {
          echo "selected";
        } ?>
        >غير متعلمة</option>
				</select>
<!--//////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
        ...
        <?php if($row["transp"]=='لا تحتاج الى مواصلات') {
          echo "selected";
        } ?>
