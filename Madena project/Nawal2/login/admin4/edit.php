...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE regdata4 set id='" . $_POST['id'] . "', Name='" . $_POST['Name'] . "', Age='" . $_POST['Age'] . "', Country='" . $_POST['Country'] . "', Phone='" . $_POST['Phone'] . "' , Address='" . $_POST['Address'] . "' , QuranKnow='" . $_POST['QuranKnow'] . "' , Level='" . $_POST['Level'] . "' , transp='" . $_POST['transp'] . "' , Notes='" . $_POST['Notes'] . "' WHERE id='" . $_POST['id'] . "'");
$message = "<div class='alert alert-success'>
تم التعديل بنجاح
</div>";
}
$result = mysqli_query($conn,"SELECT * FROM regdata4 WHERE id='" . $_GET['id'] . "'");
