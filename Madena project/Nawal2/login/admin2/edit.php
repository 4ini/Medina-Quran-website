...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE regdata2 set id='" . $_POST['id'] . "', Name='" . $_POST['Name'] . "', Age='" . $_POST['Age'] . "', Country='" . $_POST['Country'] . "', Phone='" . $_POST['Phone'] . "' , Address='" . $_POST['Address'] . "' , QuranKnow='" . $_POST['QuranKnow'] . "' , Level='" . $_POST['Level'] . "' , transp='" . $_POST['transp'] . "' , Notes='" . $_POST['Notes'] . "' WHERE id='" . $_POST['id'] . "'");
