    ...
    <div class="main">
        ...
        <div class="book">
            ...
            <form action="index.php" method="post">
                ...
                <select name="Drash" class="form-select" style="width:auto; margin-right:auto; margin-left:auto;" >
                <option value="t3lem">مستوى التعليم</option>
				<option value="متعلمة">متعلمة</option>
				<option value="غير متعلمة">غير متعلمة</option>
				</select>
...
if(isset($_POST['send']) && $_POST['send']){
    ...
    $transp = $_POST['transp'];
    $Notes = $_POST['Notes'];
    $query = "INSERT INTO regdata3(Name,Age,Country,Phone,Address,QuranKnow,Level,Drash,transp,Notes) VALUE('$Name','$Age','$Country','$Phone','$Address','$QuranKnow','$Level','$Drash','$transp','$Notes')";
